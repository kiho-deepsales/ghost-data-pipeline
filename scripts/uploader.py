...
def upload_members():
    ...
    pandas_gbq.to_gbq(members, f"{RAW_DATASET}.members_{date}", project_id=PROJECT_ID, credentials=credentials, if_exists='replace')
...
def upload_newsletters():
    ...
    if newsletters.empty:
        ...
        pandas_gbq.to_gbq(table, f"{RAW_DATASET}.newsletters", project_id=PROJECT_ID, credentials=credentials, if_exists='replace')
...
def upload_member_en_stats():
    ...
    pandas_gbq.to_gbq(table, f"{STATS_DATASET}.{MEMBER_EN_STATS_TABLE}", project_id=PROJECT_ID, credentials=credentials, if_exists='replace')
...
def upload_member_ko_stats():
    ...
    pandas_gbq.to_gbq(table, f"{STATS_DATASET}.{MEMBER_KO_STATS_TABLE}", project_id=PROJECT_ID, credentials=credentials, if_exists='replace')
...
def upload_subscriber_en_stats():
    ...
    pandas_gbq.to_gbq(table, f"{STATS_DATASET}.{SUBSCRIBER_EN_STATS_TABLE}", project_id=PROJECT_ID, credentials=credentials, if_exists='replace')
...
def upload_subscriber_ko_stats():
    ...
    pandas_gbq.to_gbq(table, f"{STATS_DATASET}.{SUBSCRIBER_KO_STATS_TABLE}", project_id=PROJECT_ID, credentials=credentials, if_exists='replace')
...
def upload_newsletter_en_stats():
    ...
    pandas_gbq.to_gbq(table, f"{STATS_DATASET}.{NEWSLETTER_EN_STATS_TABLE}", project_id=PROJECT_ID, credentials=credentials, if_exists='replace')
...
def upload_newsletter_ko_stats():
    ...
    pandas_gbq.to_gbq(table, f"{STATS_DATASET}.{NEWSLETTER_KO_STATS_TABLE}", project_id=PROJECT_ID, credentials=credentials, if_exists='replace')
